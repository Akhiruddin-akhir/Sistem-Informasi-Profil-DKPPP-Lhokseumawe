    ...
    <nav class="navbar navbar-inverse navbar-fixed-top">
      <div class="container">
        <div class="navbar-header">
          ...
          <?= anchor('home', '<img alt="Logo DKPPP" width="40" class="lazy" data-src="'.getLogo().'" src="">', ['class'=>'navbar-brand']); ?>
        </div>
          ...
          <ul class="nav navbar-nav navbar-right">
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                ...
                <li><?= anchor('profile/kepalaSekolah','Kepala Dinas'); ?></li>
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                <li><?= anchor('bidang/perikanan','Perikanan'); ?></li>
                <li><?= anchor('bidang/perkebunan','Perkebunan'); ?></li>
                <li><?= anchor('bidang/peternakan','Peternakan'); ?></li>
                
              </ul>
            </li>
           
            <li class="dropdown">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">STAFF & KARYAWAN<span class="caret"></span></a>
              <ul class="dropdown-menu">
                <li><?= anchor('guruStaf/tenagaPendidik','Karyawan'); ?></li>
                <li><?= anchor('guruStaf/stafKaryawan','Staff'); ?></li>
              </ul>
            </li>
            <li class="dropdown">
