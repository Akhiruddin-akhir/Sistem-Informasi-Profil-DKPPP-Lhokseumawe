...
<html lang="en">
  <head>
    ...
    <meta name="description" content="Web DKPPP Lhokseumawe">
    <meta name="author" content="author">
    <link rel="icon" href="<?= getLogo(); ?>">

    <title>DKPPP Lhoseumawe</title>
  ...
  <body>
    ...
    <ul class="sidebar">
      <?php $level = $this->session->userdata('SISBW')['level']; ?>
        ...
        <li class="dropdown">
          <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><span class="fi fi-home fi-lg"></span> PROFIL <span class="caret"></span></a>
          <ul class="dropdown-menu">
            <li><?= anchor('adminProfile/sejarah','Sejarah'); ?></li>
            <li><?= anchor('adminProfile/kepalaSekolah','Kepala Dinas'); ?></li>
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            <li><?= anchor('adminBidang/perikanan','Perikanan'); ?></li>
            <li><?= anchor('adminBidang/perkebunan','Pertanian'); ?></li>
            <li><?= anchor('adminBidang/peternakan','Peternakan'); ?></li>
            <li><?= anchor('adminBidang/pangan','Pangan'); ?></li>
          </ul>
        </li>
       
        <li class="dropdown">
          <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">STAFF DAN KARYAWAN<span class="caret"></span></a>
          <ul class="dropdown-menu">
            <li><?= anchor('adminGuruStaf/guru','Karyawan'); ?></li>
            <li><?= anchor('adminGuruStaf/staf','Staff'); ?></li>
          </ul>
        </li>
        <?php endif; ?>
