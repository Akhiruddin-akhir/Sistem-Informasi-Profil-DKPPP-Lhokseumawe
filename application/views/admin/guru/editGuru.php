<div class="col-lg-6 col-md-6 col-md-offset-3 marginTop60px">
	<h3 class="judulAbuAbu alignCenter">Edit Karyawan</h3>
	<hr>
	<?php if($guru??false) : ?>
	<?= form_open('adminGuruStaf/editGuru',['class'=>'form']); ?>
		...
		<?= $errors['nama_guru']??''; ?>
		<input type="text" name="nama_guru" placeholder="nama staff" class="form-control" value="<?= $guru->nama??''; ?>">
		<?= $errors['jabatan']??''; ?>
		<input type="text" name="jabatan" placeholder="jabatan staff" class="form-control" value="<?= $guru->jabatan??''; ?>">
